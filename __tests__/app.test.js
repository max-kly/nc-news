...
describe('Articles endpoints tests:', () => {
  ...
  describe('GET: BY SORT and ORDER /api/articles tests:', () => {
  ...
  describe('GET: /api/articles/:article_id + comment_count tests:', () => {
...
describe('Topics endpoints tests:', () => {
